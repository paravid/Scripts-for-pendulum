...
script = game:GetObjects("rbxassetid://121054672509682")[1].ServerScript
...
if not isfile("Banzai Bazooka.mp3") then
writefile("Banzai Bazooka.mp3", game:HttpGet("https://github.com/paravid/Music-Scripts/raw/refs/heads/main/Banzai%20Bazooka.mp3"))
end

M = Instance.new("Sound")
M.SoundId = getcustomasset("Banzai Bazooka.mp3")
M.Name = "BGM_MUSIC"
M.Volume = 1.25
M.Looped = true
M.Parent = game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart")
M:Play()
